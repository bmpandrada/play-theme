              ...
              >
                <div class='mb-10 text-center'>
                  <a
                    ...
                    class='mx-auto inline-block max-w-40'
                  >
                    <img
                      src='/images/logo/logo.svg'
                      alt='logo'
                      class={`${isDark ? "dark:hidden" : " "}`}
                    />
                    <img
                ...
                <span class='relative block text-center z-1 mb-7'>
                  ...
                  <span class='relative z-10 inline-block px-3 text-base bg-white dark:bg-dark-2 text-body-secondary'>
                    Connect With
                  </span>
                </span>
